...
export type PropertyDocumentWhereInput = {
  ...
  property_document_id?: Prisma.StringFilter<"PropertyDocument"> | string
  propertyId?: Prisma.StringFilter<"PropertyDocument"> | string
  label?: Prisma.StringFilter<"PropertyDocument"> | string
  type?: Prisma.StringFilter<"PropertyDocument"> | string
  fileUrl?: Prisma.StringFilter<"PropertyDocument"> | string
  required?: Prisma.BoolFilter<"PropertyDocument"> | boolean
...
export type PropertyDocumentOrderByWithRelationInput = {
  property_document_id?: Prisma.SortOrder
...
export type PropertyDocumentScalarWhereWithAggregatesInput = {
  ...
  property_document_id?: Prisma.StringWithAggregatesFilter<"PropertyDocument"> | string
  propertyId?: Prisma.StringWithAggregatesFilter<"PropertyDocument"> | string
  label?: Prisma.StringWithAggregatesFilter<"PropertyDocument"> | string
  type?: Prisma.StringWithAggregatesFilter<"PropertyDocument"> | string
  fileUrl?: Prisma.StringWithAggregatesFilter<"PropertyDocument"> | string
  required?: Prisma.BoolWithAggregatesFilter<"PropertyDocument"> | boolean
...
export type PropertyDocumentUpdateInput = {
  property_document_id?: Prisma.StringFieldUpdateOperationsInput | string
...
export type PropertyDocumentOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"property_document_id" | "propertyId" | "label" | "type" | "fileUrl" | "required" | "createdAt", ExtArgs["result"]["propertyDocument"]>
...
export interface PropertyDocumentDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * 
   * // Only select the `property_document_id`
   * const propertyDocumentWithProperty_document_idOnly = await prisma.propertyDocument.findMany({ select: { property_document_id: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many PropertyDocuments and only return the `property_document_id`
   * const propertyDocumentWithProperty_document_idOnly = await prisma.propertyDocument.createManyAndReturn({
   *   select: { property_document_id: true },
   *   data: [
   *     // ... provide data here
   *   ]
   * })
   ...
   * })
   * 
   * // Update zero or more PropertyDocuments and only return the `property_document_id`
   * const propertyDocumentWithProperty_document_idOnly = await prisma.propertyDocument.updateManyAndReturn({
   *   select: { property_document_id: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface PropertyDocumentFieldRefs {
  readonly property_document_id: Prisma.FieldRef<"PropertyDocument", 'String'>
  readonly propertyId: Prisma.FieldRef<"PropertyDocument", 'String'>
  readonly label: Prisma.FieldRef<"PropertyDocument", 'String'>
  readonly type: Prisma.FieldRef<"PropertyDocument", 'String'>
  readonly fileUrl: Prisma.FieldRef<"PropertyDocument", 'String'>
  readonly required: Prisma.FieldRef<"PropertyDocument", 'Boolean'>
