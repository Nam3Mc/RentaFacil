...
export type SubscriptionWhereInput = {
  ...
  model_id?: Prisma.StringFilter<"Subscription"> | string
  ...
  billing?: Prisma.StringFilter<"Subscription"> | string
...
export type SubscriptionScalarWhereWithAggregatesInput = {
  ...
  model_id?: Prisma.StringWithAggregatesFilter<"Subscription"> | string
  ...
  billing?: Prisma.StringWithAggregatesFilter<"Subscription"> | string
...
export type SubscriptionOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"model_id" | "userId" | "planId" | "status" | "billing" | "startDate" | "endDate" | "createdAt", ExtArgs["result"]["subscription"]>
...
export interface SubscriptionDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const subscriptionWithModel_idOnly = await prisma.subscription.findMany({ select: { model_id: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many Subscriptions and only return the `model_id`
   * const subscriptionWithModel_idOnly = await prisma.subscription.createManyAndReturn({
   ...
   * })
   * 
   * // Update zero or more Subscriptions and only return the `model_id`
   * const subscriptionWithModel_idOnly = await prisma.subscription.updateManyAndReturn({
   *   select: { model_id: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface SubscriptionFieldRefs {
  readonly model_id: Prisma.FieldRef<"Subscription", 'String'>
  ...
  readonly billing: Prisma.FieldRef<"Subscription", 'String'>
